...
/**
 * TestSeance 3 - ArrayListForIter
 */
public class TestSeance3ArrayListForIter {
  public static void main(String[] args) {
    ...
    for (int run : runs) {
      ...
      System.out.println("ArrayList has " + game.getWorldMap().size() + " objects. With " + run + " being not null.");
